...
export const meta = {
  ...
  canonicalObjects: [
    {
      platforms: ['swift', 'android', 'android', 'swift'],
      canonicalPath:
        '/swift/prev/build-a-backend/more-features/geo/configure-geofencing/'
    },
    {
      platforms: [
        'angular',
      ...
      canonicalPath:
        '/javascript/prev/build-a-backend/more-features/geo/configure-geofencing/'
    }
  ]
};
