...
export const meta = {
  ...
  canonicalObjects: [
    {
      platforms: ['vue', 'react', 'angular', 'nextjs', 'javascript'],
      canonicalPath:
        '/javascript/prev/build-a-backend/auth/add-social-provider/'
    }
  ]
};
...
The sample below uses Expo's [WebBrowser.openAuthSessionAsync](https://docs.expo.dev/versions/latest/sdk/webbrowser#webbrowseropenauthsessionasyncurl-redirecturl-options).
