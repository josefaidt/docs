...
export const meta = {
  ...
  description:
    'Use the Amplify CLI to connect existing AWS resources to a new app.',
  platforms: [
    'angular',
    'flutter',
    'javascript',
...
- The Amplify CLI [installed](/[platform]/tools/cli/start/set-up-cli/) and configured.
...
<img
  src="/images/existing-resources/team-provider-info-mobile-cli.png"
  alt="The team-provider-info.json file within the file directory of the Amplify app."
  width="450"
/>
...
<img
  src="/images/existing-resources/dev-amplifyappid-mobile-cli.png"
  alt="The environment and AmplifyAppId in team-provider-info.json file."
  width="450"
/>
{/* cSpell:enable */}
...
**Step 4:** Select the AWS Authentication method. In this example, we are using an AWS profile. Ensure that the selected profile has the necessary permissions to access and modify AWS resources. See [Configure the Amplify CLI](/[platform]/tools/cli/start/set-up-cli/#configure-the-amplify-cli) for more information on setting up your AWS profile.
...
<img
  src="/images/existing-resources/amplify-amplifyconfig-mobile-cli.png"
  alt="The Amplify folder and amplifyconfiguration.dart file within the file directory of the Amplify app."
  width="450"
/>
...
<img
  src="/images/existing-resources/lib-models-dart-mobile-cli.png"
  alt="The models folder within the file directory of the Amplify app."
  width="450"
/>
...
<img
  src="/images/existing-resources/team-provider-info-web-cli.png"
  alt="The team-provider-info.json file within the file directory of the Amplify app."
  width="450"
/>
...
<img
  src="/images/existing-resources/dev-amplifyappid-web-cli.png"
  alt="The environment and AmplifyAppId in team-provider-info.json file."
  width="450"
/>
{/* cSpell:enable */}
...
<img
  src="/images/existing-resources/app-root-folder-web-cli.png"
  alt="The amplify folder within the file directory of the Amplify app."
  width="450"
/>
...
<img
  src="/images/existing-resources/graphql-web-cli.png"
  alt="The graphql folder within the file directory of the Amplify app."
  width="450"
/>
...
<img
  src="/images/existing-resources/publish-app-web-cli.png"
  alt="Amplify CLI publish the app and display a URL."
  width="450"
/>
