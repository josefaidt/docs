...
<img
  src="/images/existing-resources/resources-cdk.png"
  alt="The CDK preparing for deployment."
  width="750"
/>
...
<img
  src="/images/existing-resources/cdk-stacks.png"
  alt="CDK deploying the stacks."
  width="750"
/>
...
<img
  src="/images/existing-resources/outputs-cdk.png"
  alt="awsAppsyncApiId and awsAppsyncRegion values highlighted within the outputs of the CDK stack."
  width="750"
/>
...
<img
  src="/images/existing-resources/client-helper-models2-cdk.png"
  alt="mutations.js, queries.js, and subscriptions.js within the graphql folder."
  width="400"
/>
...
<img
  src="/images/existing-resources/schema-graphql-cdk.png"
  alt="The schema.graphql file inside the graphql folder."
  width="450"
/>
...
<img
  src="/images/existing-resources/client-helper-models-cdk.png"
  alt="The ModelProvider.dart and Todo.dart files within the models folder."
  width="450"
/>
