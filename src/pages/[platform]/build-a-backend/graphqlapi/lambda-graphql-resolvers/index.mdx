...
To learn more about the `@function` directive, check out the GraphQL Transform documentation [here](/[platform]/build-a-backend/graphqlapi/custom-business-logic/#lambda-function-resolver).
