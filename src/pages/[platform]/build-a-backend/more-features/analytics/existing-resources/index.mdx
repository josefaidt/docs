  ...
  canonicalObjects: [
    {
      ...
      canonicalPath:
        '/javascript/build-a-backend/more-features/analytics/existing-resources/'
    },
    {
      platforms: ['react', 'angular', 'nextjs', 'vue'],
      canonicalPath:
        '/react/build-a-backend/more-features/analytics/existing-resources/'
    }
  ]
};
