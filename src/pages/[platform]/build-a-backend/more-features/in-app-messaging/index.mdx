...
export const meta = {
  ...
  route: '/[platform]/build-a-backend/more-features/in-app-messaging',
  canonicalObjects: [
    {
      platforms: ['nextjs', 'javascript', 'vue', 'react', 'angular'],
      canonicalPath:
        '/javascript/build-a-backend/more-features/in-app-messaging/'
    }
  ]
};
