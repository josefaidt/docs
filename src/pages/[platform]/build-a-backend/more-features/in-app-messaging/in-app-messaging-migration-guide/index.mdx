...
export const meta = {
  ...
  description:
    'Learn more about the migration steps to upgrade In-app messaging APIs for Amplify JavaScript v5 to v6',
  platforms: [
    'javascript',
    'react-native',
    'angular',
  ...
  canonicalObjects: [
    {
      ...
      canonicalPath:
        '/javascript/build-a-backend/more-features/in-app-messaging/in-app-messaging-migration-guide/'
    }
  ]
};
