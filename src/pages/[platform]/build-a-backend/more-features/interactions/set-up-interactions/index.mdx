...
export const meta = {
  ...
  canonicalObjects: [
    {
      platforms: ['react', 'nextjs', 'javascript', 'angular', 'vue'],
      canonicalPath:
        '/javascript/build-a-backend/more-features/interactions/set-up-interactions/'
    }
  ]
};
...
This is a [known issue](https://github.com/aws/aws-sdk-js-v3/issues/4877). Please follow [the steps](https://github.com/aws/aws-sdk-js-v3/issues/4877#issuecomment-1656007484) outlined in the linked issue to resolve the error.
