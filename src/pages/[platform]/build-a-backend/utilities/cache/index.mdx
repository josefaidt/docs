...
For the complete API documentation for Cache module, visit our [API Reference](https://aws-amplify.github.io/amplify-js/api/classes/aws_amplify.utils._Reference_Types_.StorageCache.html)
