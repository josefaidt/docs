...
export const meta = {
  title: 'Storage',
  description:
    'Learn more about how you can manage user content for your app in public, protected or private storage buckets using Amplify Storage.',
  platforms: [
    'android',
    'angular',
    'flutter',
  ...
  canonicalObjects: [
    {
      ...
      canonicalPath: '/javascript/build-a-backend/storage/'
    }
  ]
};
