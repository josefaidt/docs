...
The easiest way to get started with AWS Amplify is through [npm](https://npmjs.com) with [`create-amplify`](https://www.npmjs.com/package/create-amplify), which is the workflow our [quickstart](/[platform]/start/quickstart) recommends. However, for some use cases, it may be preferable to start from scratch, either with a brand new directory or an existing frontend app. This guide will walk you through how to initialize your project, install dependencies, and author your first backend.
...
```json title="amplify/package.json"
{
  "type": "module"
}
```
