...
- [`@model`: Defines top level object types in your API that are backed by Amazon DynamoDB](/[platform]/tools/cli-legacy/model-directive/)
- [`@key`: Configures custom index structures for @model types](/[platform]/tools/cli-legacy/key-directive/)
- [`@auth`: Defines authorization rules for your @model types and fields](/[platform]/tools/cli-legacy/auth-directive/)
- [`@connection`: Defines 1:1, 1:M, and N:M relationships between @model types](/[platform]/tools/cli-legacy/connection-directive/)
- [`@function`: Configures a Lambda function resolvers for a field](/[platform]/tools/cli-legacy/function-directive/)
- [`@http`: Configures an HTTP resolver for a field](/[platform]/tools/cli-legacy/http-directive/)
- [`@predictions`: Queries an orchestration of AI/ML services such as Amazon Rekognition, Amazon Translate, and/or Amazon Polly](/[platform]/tools/cli-legacy/predictions-directive/)
- [`@searchable`: Makes your data searchable by streaming it to Amazon OpenSearch](/[platform]/tools/cli-legacy/searchable-directive/)
- [`@versioned`: Defines the versioning and conflict resolution strategy for an @model type](/[platform]/tools/cli-legacy/versioned-directive/)
