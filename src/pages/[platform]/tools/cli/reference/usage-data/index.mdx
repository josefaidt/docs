  ...
  canonicalObjects: [
    {
      ...
      canonicalPath: '/javascript/tools/cli/reference/usage-data/'
    }
  ]
};
...
\*_Usage data collection is managed on a machine per installation basis enabling/disabling will change it for all the projects on that instance_
