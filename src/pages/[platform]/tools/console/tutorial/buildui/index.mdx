...
1. **Clone the [Amplify UI Figma file](https://www.figma.com/community/file/1047600760128127424)** ![Screenshot showing how to sync with Figma](/images/studio/sync-with-figma.png) The Amplify UI Figma file provides a starting point for your app. It includes common UI primitives and pre-built UI components.
