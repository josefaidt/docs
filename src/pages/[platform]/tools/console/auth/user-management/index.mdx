...
A user can be confirmed by using the [pre-built UI components](/[platform]/build-a-backend/auth/set-up-auth/#enable-sign-up-sign-in-and-sign-out), [Amplify libraries](https://aws-amplify.github.io/amplify-js/api/modules/aws_amplify.auth.html)
